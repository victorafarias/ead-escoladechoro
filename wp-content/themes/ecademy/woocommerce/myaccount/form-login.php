...
<div class="u-columns col2-set" id="customer_login">
    ...
    <div class="row">
        ...
        <?php endif; ?>
            ...
            <h3 class="title"><?php esc_html_e( 'Login', 'ecademy' ); ?></h3>
            ...
            <form class="woocommerce-form woocommerce-form-login login" method="post">
                ...
                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                    <label for="username"><?php esc_html_e( 'Username or email address', 'ecademy' ); ?>&nbsp;<span class="required">*</span></label>
                ...
                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                    <label for="password"><?php esc_html_e( 'Password', 'ecademy' ); ?>&nbsp;<span class="required">*</span></label>
                ...
                <p class="form-row">
                    <label class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme">
                        <input class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever" /> <span><?php esc_html_e( 'Remember me', 'ecademy' ); ?></span>
                    </label>
                    <?php wp_nonce_field( 'woocommerce-login', 'woocommerce-login-nonce' ); ?>
                    <button type="submit" class="woocommerce-button button woocommerce-form-login__submit btn btn-primary order-btn" name="login" value="<?php esc_attr_e( 'Log in', 'ecademy' ); ?>"><?php esc_html_e( 'Log in', 'ecademy' ); ?></button>
                </p>
                <p class="woocommerce-LostPassword lost_password">
                    <a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Lost your password?', 'ecademy' ); ?></a>
                </p>
