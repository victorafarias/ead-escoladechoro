...
$course_access  = function_exists('get_field') ? get_field('course_access') : '';
$hide_banner    = function_exists('get_field') ? get_field('hide_course_page_banner') : '';
$is_rating      = function_exists('get_field') ? get_field('hide_course_banner_rating') : '';
$is_breadcrumb  = function_exists('get_field') ? get_field('hide_course_banner_breadcrumb') : '';
$course_time    = function_exists('get_field') ? get_field('course_time') : '';
...
if (function_exists('get_field') && get_field('course_buy_now_title') != '') {
...
?>
    ...
    <div class="page-title-area <?php if( $is_rating == true && $is_breadcrumb == true ): ?>ptb-50<?php endif; ?>" <?php if( function_exists('get_field') && get_field('course_single_background_image_main') != '' ): ?>style="background-image:url(<?php echo esc_url(get_field('course_single_background_image_main')); ?>);"<?php endif; ?>>
            <div class="container">
    ...
    <div class="courses-details-area pb-100">
        <?php if( function_exists('get_field') && get_field('course_single_background_image') != '' ): ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="courses-details-info">
                        <?php if( function_exists('get_field') && get_field('course_preview_title') != '' || function_exists('get_field') && get_field('course_preview_video_link') != ''): ?>
                            <?php if( get_field('course_preview_style') != 'without_popup' ): ?>
                                <div class="image">
                                    ...
                                    <?php if( get_field('course_preview_video_link') != '' ): ?>
                            ...
                            <div class="courses-share">
                                <div class="share-info">
                                    ...
                                    <ul class="social-link">
                                        ...
                                        <li><a href="https://twitter.com/share?url='<?php echo urlencode( get_permalink() ); ?>&amp;text=<?php echo rawurlencode( esc_attr( get_the_title() ) ); ?>" class="d-block" target="_blank"><svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            if( $query->have_posts() ) { ?>
                <section class="courses-area bg-f8f9f8 pt-100 pb-70">
                    <div class="container">
                        ...
                        <div class="row">
                            <?php while ( $query->have_posts() ) : $query->the_post(); $course         = LP_Global::course(); ?>
