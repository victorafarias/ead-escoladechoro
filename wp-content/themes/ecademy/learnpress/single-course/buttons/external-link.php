 ...
 *
 * This template can be overridden by copying it to edali/learnpress/single-course/buttons/continue.php.
 *
 * @author   ThimPress
...
<form name="course-external-link" class="course-external-link form-button lp-form" method="post">
	...
	<button type="submit" class="lp-button button default-btn"><i class="flaticon-tag"></i><?php echo esc_html( $course->get_external_link_text() ); ?><span></span></button>
