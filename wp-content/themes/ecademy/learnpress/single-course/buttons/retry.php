 ...
 *
 * This template can be overridden by copying it to edali/learnpress/single-course/buttons/retake.php.
 *
 * @author   ThimPress
...
$message_data_confirm = sprintf(
	'%s "%s"',
	esc_html__( 'Do you want to retake course', 'guto-lite' ),
	$course->get_title()
);
?>
...
<form name="lp-form-retake-course" class="lp-form-retake-course" method="post" enctype="multipart/form-data"
	...
	<button class="lp-button button button-retake-course default-btn">
		<i class="flaticon-tag"></i>
		<?php echo sprintf( '%s (%d)', esc_html__( 'Retake course', 'guto-lite' ), $can_retake_times ); ?>
		<span></span>
	</button>
