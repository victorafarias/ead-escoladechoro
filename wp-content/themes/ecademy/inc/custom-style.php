...
if ( ! function_exists( 'ecademy_custom_style' ) ) {
    function ecademy_custom_style(){
        ...
        $custom_style ='';
            ...
            $primary_color = isset($ecademy_opt['primary_color']) ? $ecademy_opt['primary_color'] : '#fe4a55';
            $footer_bg = isset($ecademy_opt['footer_bg']) ? $ecademy_opt['footer_bg'] : '#100f1f';
            $header_bg_color = isset($ecademy_opt['header_background_color']) ? $ecademy_opt['header_background_color'] : '#ffffff';
            $primary_btn_bg_color = isset($ecademy_opt['primary_btn_bg_color']) ? $ecademy_opt['primary_btn_bg_color'] : '#fe4a55';
            $primary_btn_hover_bg_color = isset($ecademy_opt['primary_btn_hover_bg_color']) ? $ecademy_opt['primary_btn_hover_bg_color'] : '#fe4a55';
            $primary_btn_color = isset($ecademy_opt['primary_btn_color']) ? $ecademy_opt['primary_btn_color'] : '#fff';
            $primary_btn_hover_color = isset($ecademy_opt['primary_btn_hover_color']) ? $ecademy_opt['primary_btn_hover_color'] : '#fff';
            $kitchen_color = isset($ecademy_opt['kitchen_color']) ? $ecademy_opt['kitchen_color'] : '#72ae44';
            $footer_item_color = isset($ecademy_opt['footer_item_color']) ? $ecademy_opt['footer_item_color'] : '#e4e4e4';
            $btn_enable_effect = isset($ecademy_opt['btn_enable_effect']) ? $ecademy_opt['btn_enable_effect'] : '';
            ...
            $custom_style .='
                ...
                :root {
                    ...
                    --SparklingAppleColor: '.esc_attr($kitchen_color).';
                } ';

                if($primary_btn_bg_color){
                    $custom_style .='
                    .default-btn{
                        background-color: '.esc_attr($primary_btn_bg_color).';
                    }
                   .newsletter-form button {
                        background-color: '.esc_attr($primary_btn_bg_color).' !important;
                    }
                    ';
                }
                if($primary_btn_hover_bg_color){
                    $custom_style .='
                    .default-btn span {
                        background-color: '.esc_attr($primary_btn_hover_bg_color).';
                    }
                    .newsletter-form button span {
                        background-color: '.esc_attr($primary_btn_hover_bg_color).' !important;
                    }';
                }
                ...
                if($primary_btn_color){
                    $custom_style .='
                    .default-btn {
                        color: '.esc_attr($primary_btn_color).';
                    }';
                }
                if($primary_btn_hover_color){
                    $custom_style .='
                    .default-btn:hover {
                        color: '.esc_attr($primary_btn_hover_color).';
                    }';
                }
                
                if($btn_enable_effect == 'simple'){
                    $custom_style .='
                    .default-btn span {
                        display: none;
                    }
            ...
            if ( function_exists('get_field') ) {
                ...
                // Course Meta
                if( isset($ecademy_opt['hide_course_card_meta'] ) && !empty($ecademy_opt['hide_course_card_meta']) ):
                    if($ecademy_opt['hide_course_card_meta'] == true):
                        $custom_style .= '.single-courses-box .courses-content .courses-box-footer, .single-courses-item .courses-content .courses-content-footer{display: none !important;}';
                    endif;
                endif;
