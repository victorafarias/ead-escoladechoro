...
if ( ! function_exists( 'ecademy_widgets_init' ) ) {
    function ecademy_widgets_init() {
        ...
        if ( class_exists( 'BuddyPress' ) ) {
            register_sidebar( array(
                'name' => esc_html__( 'Activity Directory Top Sidebar', 'ecademy' ),
                'id' => 'activity_top_sidebar',
                'class' => '',
                'description' => esc_html__( 'Widgets in this area will shown on News feed page.', 'ecademy' ),
                'before_widget' => '<div id="%1$s" class="widget blog_widget %2$s">',
                'after_widget' => '</div>',
                'before_title' => '<h5 class="widget-title"><span>',
                'after_title' => '</span></h5>',
            ...
            register_sidebar( array(
                'name' => esc_html__( 'Activity Directory Sidebar', 'ecademy' ),
                'id' => 'activity_sidebar',
                'class' => '',
                'description' => esc_html__( 'Widgets in this area will shown on News feed page.', 'ecademy' ),
                'before_widget' => '<div id="%1$s" class="widget blog_widget %2$s">',
            ...
            register_sidebar( array(
                'name' => esc_html__( 'Groups Directory Sidebar', 'ecademy' ),
                'id' => 'groups_sidebar',
                'class' => '',
                'description' => esc_html__( 'Widgets in this area will shown on Groups page.', 'ecademy' ),
                'before_widget' => '<div id="%1$s" class="widget blog_widget %2$s">',
                'after_widget' => '</div>',
                'before_title' => '<h5 class="widget-title"><span>',
                'after_title' => '</span></h5>',
            ...
            register_sidebar( array(
                'name' => esc_html__( 'Members Single Profile Sidebar', 'ecademy' ),
                'id' => 'member_single_sidebar',
                'class' => '',
                'description' => esc_html__( 'Widgets in this area will shown on individual member profiles.', 'ecademy' ),
                'before_widget' => '<div id="%1$s" class="widget blog_widget %2$s">',
                'after_widget' => '</div>',
                'before_title' => '<h5 class="widget-title"><span>',
                'after_title' => '</span></h5>',
        ...
        if ( class_exists( 'SFWD_LMS' ) ) {
            register_sidebar( array(
                'name'          => esc_html__( 'Course Widget', 'ecademy' ),
                'id'            => 'course-sidebar',
                'description'   => esc_html__( 'Add widgets here.', 'ecademy' ),
                'before_widget' => '<div class="widget %2$s">',
                'after_widget'  => '</div>',
...
add_action( 'redux/loaded', 'ecademy_widgets_init' );