...
$ld_enrolled = !empty($ecademy_opt['ld_enrolled']) ? $ecademy_opt['ld_enrolled'] : '';
$ld_completed = !empty($ecademy_opt['ld_completed']) ? $ecademy_opt['ld_completed'] : '';
$ld_currency = !empty($ecademy_opt['ld_currency']) ? $ecademy_opt['ld_currency'] : '';
