...
class LP_Addon_Certificates extends LP_Addon {
	...
	public function profile_tabs( $tabs ) {
		$tabs['certificates'] = array(
			'title'    => esc_html__( 'Certificates', 'ecademy-toolkit' ),
	...
	public function add_script_data() {
		...
		$assets->add_script_data(
			...
			array(
				...
				'i18n'        => array(
					'confirm_remove_layer' => __( 'Delete this layer?', 'ecademy-toolkit' ),
				),
			)
		);
	}
		...
		return apply_filters(
			...
			array(
				array(
					...
					'title' => __( 'Course name', 'ecademy-toolkit' ),
				),
				array(
					'name'  => 'student-name',
					'icon'  => 'dashicons-admin-users',
					'title' => __( 'Student name', 'ecademy-toolkit' ),
				),
				array(
					'name'  => 'course-start-date',
					'icon'  => 'dashicons-calendar-alt',
					'title' => __( 'Course start date', 'ecademy-toolkit' ),
				),
				array(
					'name'  => 'course-end-date',
					'icon'  => 'dashicons-calendar-alt',
					'title' => __( 'Course end date', 'ecademy-toolkit' ),
				),
				array(
					'name'  => 'current-time',
					'icon'  => 'dashicons-clock',
					'title' => __( 'Current time', 'ecademy-toolkit' ),
				),
				array(
					'name'  => 'verified-link',
					'icon'  => 'dashicons-yes',
					'title' => __( 'QR code', 'ecademy-toolkit' ),
				),
				array(
					'name'  => 'custom',
					'icon'  => 'dashicons-smiley',
					'title' => __( 'Custom', 'ecademy-toolkit' ),
				),
			)
		);
	}
