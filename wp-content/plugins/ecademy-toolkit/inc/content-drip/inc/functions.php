...
if ( ! function_exists( 'lp_content_drip_types' ) ) {
	...
	function lp_content_drip_types() {
		$types = array(
			'specific_date' => __( '1. Specific time after enrolled course', 'ecademy-toolkit' ),
			'sequentially'  => __( '2. Open the course items sequentially', 'ecademy-toolkit' ),
			'prerequisite'  => __( '3. Open item bases on prerequisite items', 'ecademy-toolkit' )
		);
