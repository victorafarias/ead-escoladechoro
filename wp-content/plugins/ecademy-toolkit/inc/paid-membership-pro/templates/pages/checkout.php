	...
	" method="post">
		...
		<table id="pmpro_pricing_fields" class="pmpro_checkout" width="100%" cellpadding="0" cellspacing="0" border="0">
			<thead>
				<tr>
					<th>
						<span class="pmpro_thead-name"><?php esc_html_e( 'Membership Level', 'learnpress-paid-membership-pro' ); ?></span>
			...
			<tbody>
						...
						<?php if ( $pmpro_show_discount_code ) { ?>
							<?php if ( $discount_code && ! $pmpro_review ) { ?>
								<p id="other_discount_code_p" class="pmpro_small">
									<a id="other_discount_code_a" href="#discount_code"><?php esc_html_e( 'Click here to change your discount code', 'learnpress-paid-membership-pro' ); ?></a>.
								</p>
							<?php } elseif ( ! $pmpro_review ) { ?>
								<p id="other_discount_code_p" class="pmpro_small"><?php esc_html_e( 'Do you have a discount code?', 'learnpress-paid-membership-pro' ); ?>
									<a id="other_discount_code_a" href="#discount_code"><?php esc_html_e( 'Click here to enter your discount code', 'learnpress-paid-membership-pro' ); ?></a>.
								</p>
							<?php } elseif ( $pmpro_review && $discount_code ) { ?>
								<p>
									<strong><?php esc_html_e( 'Discount Code', 'learnpress-paid-membership-pro' ); ?>:</strong> <?php echo $discount_code; ?>
								</p>
							<?php } ?>
				...
				<?php if ( $pmpro_show_discount_code ) : ?>
					<tr id="other_discount_code_tr" style="display: none;">
						<td>
							<div>
								<label for="other_discount_code"><?php esc_html_e( 'Discount Code', 'learnpress-paid-membership-pro' ); ?></label>
								...
								<input type="button" name="other_discount_code_button" id="other_discount_code_button" value="<?php esc_html_e( 'Apply', 'learnpress-paid-membership-pro' ); ?>" />
							</div>
						</td>
					</tr>
				<?php endif; ?>
		...
		<?php if ( ! $skip_account_fields && ! $pmpro_review ) { ?>
			<table id="pmpro_user_fields" class="pmpro_checkout" width="100%" cellpadding="0" cellspacing="0" border="0">
				<thead>
					<tr>
						<th>
							<span class="pmpro_thead-name"><?php esc_html_e( 'Account Information', 'learnpress-paid-membership-pro' ); ?></span>
							<span class="pmpro_thead-msg"><?php esc_html_e( 'Already have an account?', 'learnpress-paid-membership-pro' ); ?>
				...
				<tbody>
					<tr>
						<td>
							<div>
								<label for="username"><?php esc_html_e( 'Username', 'learnpress-paid-membership-pro' ); ?></label>
							...
							<div>
								<label for="password"><?php esc_html_e( 'Password', 'learnpress-paid-membership-pro' ); ?></label>
							...
							if ( $pmpro_checkout_confirm_password ) {
								?>
								<div>
									<label for="password2"><?php esc_html_e( 'Confirm Password', 'learnpress-paid-membership-pro' ); ?></label>
							...
							<div>
								<label for="bemail"><?php esc_html_e( 'E-mail Address', 'learnpress-paid-membership-pro' ); ?></label>
							...
							if ( $pmpro_checkout_confirm_email ) {
								?>
								<div>
									<label for="bconfirmemail"><?php esc_html_e( 'Confirm E-mail Address', 'learnpress-paid-membership-pro' ); ?></label>
							...
							<div class="pmpro_hidden">
								<label for="fullname"><?php esc_html_e( 'Full Name', 'learnpress-paid-membership-pro' ); ?></label>
					...
					<td>
						...
						<span class="gateway_paypal">
							...
							if ( ! $gateway || $gateway == 'paypal' ) {
								?>
								checked="checked"<?php } ?> />
							<a href="javascript:void(0);" class="pmpro_radio"><?php esc_html_e( 'Check Out with a Credit Card Here', 'learnpress-paid-membership-pro' ); ?></a>
						</span>
							...
							if ( $gateway == 'paypalexpress' ) {
								?>
								checked="checked"<?php } ?> />
							<a href="javascript:void(0);" class="pmpro_radio"><?php esc_html_e( 'Check Out with PayPal', 'learnpress-paid-membership-pro' ); ?></a>
						</span>
						</div>
					</td>
				</tr>
		...
		if ( $pmpro_include_billing_address_fields ) {
			...
			if ( ! $pmpro_requirebilling || apply_filters( 'pmpro_hide_billing_address_fields', false ) ) {
				...
				<tr>
					<td>
						<div>
							<label for="bfirstname"><?php esc_html_e( 'First Name', 'learnpress-paid-membership-pro' ); ?></label>
						...
						<div>
							<label for="blastname"><?php esc_html_e( 'Last Name', 'learnpress-paid-membership-pro' ); ?></label>
						...
						<div>
							<label for="baddress1"><?php esc_html_e( 'Address 1', 'learnpress-paid-membership-pro' ); ?></label>
						...
						<div>
							<label for="baddress2"><?php esc_html_e( 'Address 2', 'learnpress-paid-membership-pro' ); ?></label>
						...
						if ( $longform_address ) {
							?>
							<div>
								<label for="bcity"><?php esc_html_e( 'City', 'learnpress-paid-membership-pro' ); ?></label>
							...
							<div>
								<label for="bstate"><?php esc_html_e( 'State', 'learnpress-paid-membership-pro' ); ?></label>
							...
							<div>
								<label for="bzipcode"><?php esc_html_e( 'Postal Code', 'learnpress-paid-membership-pro' ); ?></label>
						...
						<?php } else { ?>
							...
							<div>
								<label for="bcity_state_zip"><?php esc_html_e( 'City, State Zip', 'learnpress-paid-membership-pro' ); ?></label>
								...
								if ( $state_dropdowns === true || $state_dropdowns == 'names' ) {
									...
									<select name="bstate" class=" <?php echo pmpro_getClassForField( 'bstate' ); ?>">
										...
										<?php foreach ( $pmpro_states as $ab => $st ) : ?>
											<option value="<?php echo esc_attr( $ab ); ?>" <?php echo ( $ab == $bstate ) ? 'selected="selected"' : ''; ?>><?php echo $st; ?></option>
										<?php endforeach; ?>
									</select>
									...
									<select name="bstate" class=" <?php echo pmpro_getClassForField( 'bstate' ); ?>">
										...
										<?php foreach ( $pmpro_states_abbreviations as $ab ) : ?>
											<option value="<?php echo esc_attr( $ab ); ?>"<?php echo ( $ab == $bstate ) ? 'selected="selected"' : ''; ?>><?php echo $ab; ?></option>
										<?php endforeach; ?>
									</select>
						...
						if ( $show_country ) {
							?>
							<div>
								<label for="bcountry"><?php esc_html_e( 'Country', 'learnpress-paid-membership-pro' ); ?></label>
								<select name="bcountry" class=" <?php echo pmpro_getClassForField( 'bcountry' ); ?>">
									...
									foreach ( $pmpro_countries as $abbr => $country ) {
										?>
										<option value="<?php echo esc_attr( $abbr ); ?>"<?php echo ( $abbr == $bcountry ) ? ' selected="selected"' : ''; ?>><?php echo $country; ?></option>
										<?php
									}
									?>
								</select>
						...
						<div>
							<label for="bphone"><?php esc_html_e( 'Phone', 'learnpress-paid-membership-pro' ); ?></label>
						...
						<?php if ( $skip_account_fields ) { ?>
							...
							if ( $pmpro_checkout_confirm_email ) {
								?>
								<div>
									<label for="bconfirmemail"><?php esc_html_e( 'Confirm E-mail', 'learnpress-paid-membership-pro' ); ?></label>
									<input id="bconfirmemail" name="bconfirmemail" type="<?php echo( $pmpro_email_field_type ? 'email' : 'text' ); ?>" class="input <?php echo pmpro_getClassForField( 'bconfirmemail' ); ?>" size="30" value="<?php echo esc_attr( $bconfirmemail ); ?>" />
		...
		if ( $pmpro_include_payment_information_fields ) {
			...
			if ( ! $pmpro_requirebilling || apply_filters( 'pmpro_hide_payment_information_fields', false ) ) {
				...
				<thead>
					<tr>
						<th>
							<span class="pmpro_thead-name"><?php esc_html_e( 'Payment Information', 'learnpress-paid-membership-pro' ); ?></span>
							<span class="pmpro_thead-msg"><?php printf( __( 'We Accept %s', 'learnpress-paid-membership-pro' ), $pmpro_accepted_credit_cards_string ); ?></span>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<td>
						...
						if ( $pmpro_include_cardtype_field ) {
							...
							<div class="pmpro_payment-card-type">
								<label for="CardType"><?php esc_html_e( 'Card Type', 'learnpress-paid-membership-pro' ); ?></label>
								<select id="CardType" name="CardType" class=" <?php echo pmpro_getClassForField( 'CardType' ); ?>">
									<?php foreach ( $pmpro_accepted_credit_cards as $cc ) : ?>
										<option value="<?php echo $cc; ?>"<?php echo ( $CardType == $cc ) ? ' selected="selected"' : ''; ?>><?php echo $cc; ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						<?php } else { ?>
						...
						<div class="pmpro_payment-account-number">
							<label for="AccountNumber"><?php esc_html_e( 'Card Number', 'learnpress-paid-membership-pro' ); ?></label>
						...
						<div class="pmpro_payment-expiration">
							<label for="ExpirationMonth"><?php esc_html_e( 'Expiration Date', 'learnpress-paid-membership-pro' ); ?></label>
							<select id="ExpirationMonth" name="ExpirationMonth" class=" <?php echo pmpro_getClassForField( 'ExpirationMonth' ); ?>">
								...
								for ( $i = date_i18n( 'Y' ); $i < intval( date_i18n( 'Y' ) ) + 10; $i ++ ) {
									?>
									<option value="<?php echo $i; ?>"<?php echo ( $ExpirationYear == $i ) ? ' selected="selected"' : ''; ?>><?php echo $i; ?></option>
									<?php
								}
								?>
							</select>
						...
						if ( $pmpro_show_cvv ) {
							...
							<div class="pmpro_payment-cvv">
								...
								<small>(<a href="javascript:void(0);" onclick="javascript:window.open('<?php echo pmpro_https_filter( PMPRO_URL ); ?>/pages/popup-cvv.html','cvv','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=600, height=475');"><?php esc_html_e( "what's this?", 'learnpress-paid-membership-pro' ); ?></a>)
								</small>
							</div>
						<?php } ?>
						...
						<?php if ( $pmpro_show_discount_code ) : ?>
							<div class="pmpro_payment-discount-code">
								<label for="discount_code"><?php esc_html_e( 'Discount Code', 'learnpress-paid-membership-pro' ); ?></label>
								...
								<input type="button" id="discount_code_button" name="discount_code_button" value="<?php esc_html_e( 'Apply', 'learnpress-paid-membership-pro' ); ?>" />
				...
				<tbody>
					<tr class="odd">
						<td>
							...
							<label class="pmpro_normal pmpro_clickable" for="tos"><?php printf( __( 'I agree to the %s', 'learnpress-paid-membership-pro' ), $tospage->post_title ); ?></label>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<div class="pmpro_submit">
			<?php if ( $pmpro_review ) { ?>
				<span id="pmpro_submit_span">
					...
					<input type="submit" class="pmpro_btn pmpro_btn-submit-checkout" value="<?php esc_html_e( 'Complete Payment', 'learnpress-paid-membership-pro' ); ?> &raquo;" />
				</span>
			<?php } else { ?>
				<?php
