        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .single-courses-box .courses-image .price' => 'background-color: {{VALUE}} !important',
                        '{{WRAPPER}} .single-courses-box .courses-content h3 a:hover' => 'color: {{VALUE}}',
                    ],
                ]
            );
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .single-courses-box .courses-content h3' => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .single-courses-box .courses-content h3 ',
                ]
            );
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}}.single-courses-box .courses-content p' => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_group_control(
                ...
                [
                    ...
                    'scheme' => Core\Schemes\Typography::TYPOGRAPHY_1,
                    'selector' => '{{WRAPPER}} .single-courses-box .courses-content p',
                ]
            );
