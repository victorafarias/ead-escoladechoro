...
class eCademy_Banner_Six extends Widget_Base {

	public function get_name() {
        return 'eCademy_Banner_Six';
    }

	public function get_title() {
        return esc_html__( 'Banner Six', 'ecademy-toolkit' );
    }
        ...
        $this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> esc_html__('Express your thoughts by Drawing and Coloring', 'ecademy-toolkit'),
					'dynamic' => [
						'active' => true,
					],
				]
			...
			$this->add_control(
				...
				[
					...
					'type' 		=> Controls_Manager::TEXT,
					'default' 	=> esc_html__('Find Courses', 'ecademy-toolkit'),
				]
            );
            ...
            $this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .online-art-banner-area' => 'background-color: {{VALUE}}',
					],
				]
			);
        ...
        $this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .online-art-banner-content .el-title' => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .online-art-banner-content .el-title',
                ]
            );
            ...
            $this->add_responsive_control(
                'text_padding',
                [
                    'label' => esc_html__( 'Padding', 'ecademy-toolkit' ),
                    'type' => Controls_Manager::DIMENSIONS,
	...
	protected function render() {
		...
		?>
        <div class="online-art-banner-area" style="background-image:url(<?php echo esc_url($settings['bg_image']['url']); ?>);">
                        ...
                        <div class="online-art-banner-content">
                            ...
                            <?php if( $button_text != '' ): ?>
								<div class="banner-btn">
                                    <a href="<?php echo esc_url( $link ); ?>" class="default-btn"><i class="flaticon-user"></i><?php echo esc_html( $button_text ); ?><span></span></a>
                                </div>
							<?php endif; ?>
                        </div>
                    </div>
...
Plugin::instance()->widgets_manager->register( new eCademy_Banner_Six );