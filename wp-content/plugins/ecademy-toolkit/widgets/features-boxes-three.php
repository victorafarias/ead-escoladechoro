...
class eCademy_Features_Boxe_Three extends Widget_Base {

	public function get_name() {
        return 'eCademy_Features_Box_Three';
    }

	public function get_title() {
        return esc_html__( 'Features Three', 'ecademy-toolkit' );
    }
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .instructor-boxes-card h3',
                ]
            );
            ...
            $this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .instructor-boxes-card h3' => 'color: {{VALUE}}',
					],
				]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'scheme' => Core\Schemes\Typography::TYPOGRAPHY_1,
                    'selector' => '{{WRAPPER}} .instructor-boxes-card p',
                ]
            );
            ...
            $this->add_control(
				...
				[
					...
					'type' => Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .instructor-boxes-card p' => 'color: {{VALUE}}',
					],
				]
            );
        $this->end_controls_section();
...
Plugin::instance()->widgets_manager->register( new eCademy_Features_Boxe_Three );