 ...
 *
 * @class    UR_Form_Field_Billing_Postcode
 * @version  1.0.0
...
/**
 * UR_Form_Field_Billing_Postcode Class
 */
class UR_Form_Field_Billing_Postcode extends UR_Form_Field {
	...
	public function __construct() {
		...
		$this->id = 'user_registration_billing_postcode';
		...
		$this->field_defaults           = array(
			...
			'default_field_name' => 'billing_postcode',
		);
	...
	public function settings_override( $file_path_override ) {
		$file_path_override['file_path'] = URWC_ABSPATH . 'includes' . UR_DS . 'form' . UR_DS . 'settings' . UR_DS . 'class-ur-setting-billing-postcode.php';
...
return UR_Form_Field_Billing_Postcode::get_instance();
