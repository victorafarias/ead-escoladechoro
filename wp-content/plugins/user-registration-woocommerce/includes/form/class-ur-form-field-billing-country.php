 ...
 *
 * @class    UR_Form_Field_Billing_Country
 * @version  1.0.0
...
/**
 * UR_Form_Field_Billing_Country Class
 */
class UR_Form_Field_Billing_Country extends UR_Form_Field {
	...
	public function __construct() {
		...
		$this->id = 'user_registration_billing_country';
		...
		$this->field_defaults = array(
			...
			'default_field_name' => 'billing_country',
		);
	}
...
return UR_Form_Field_Billing_Country::get_instance();
