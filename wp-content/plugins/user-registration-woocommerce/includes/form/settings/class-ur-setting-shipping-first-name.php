...
/**
 * UR_Setting_Shipping_first_name Class
 *
 * @package  UserRegistrationWooCommerce/Form/Settings
 * @category Abstract Class
 * @author   WPEverest
 */
class UR_Setting_Shipping_first_name extends UR_Field_Settings {


	public function __construct() {
		$this->field_id = 'shipping_first_name_advance_setting';
	}
...
return new UR_Setting_Shipping_first_name();
