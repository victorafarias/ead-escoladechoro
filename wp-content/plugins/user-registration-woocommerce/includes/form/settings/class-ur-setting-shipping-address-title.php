...
/**
 * UR_Setting_Shipping_address_title Class
 *
 * @package  UserRegistrationWooCommerce/Form/Settings
 * @category Abstract Class
 * @author   WPEverest
 */
class UR_Setting_Shipping_address_title extends UR_Field_Settings {


	public function __construct() {
		$this->field_id = 'shipping_address_title_advance_setting';
	}
...
return new UR_Setting_Shipping_address_title();
