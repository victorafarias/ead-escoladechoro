...
/**
 * UR_Setting_Shipping_state Class
 *
 * @package  UserRegistrationWooCommerce/Form/Settings
 * @category Abstract Class
 * @author   WPEverest
 */
class UR_Setting_Shipping_state extends UR_Field_Settings {


	public function __construct() {
		$this->field_id = 'shipping_state_advance_setting';
	}
...
return new UR_Setting_Shipping_state();
