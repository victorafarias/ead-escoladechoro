...
/**
 * UR_Setting_Billing_phone Class
 *
 * @package  UserRegistrationWooCommerce/Form/Settings
 * @category Abstract Class
 * @author   WPEverest
 */
class UR_Setting_Billing_phone extends UR_Field_Settings {


	public function __construct() {
		$this->field_id = 'billing_phone_advance_setting';
	}
...
return new UR_Setting_Billing_phone();
