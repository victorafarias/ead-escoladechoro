...
/**
 * UR_Setting_Separate_shipping Class
 *
 * @package  UserRegistrationWooCommerce/Form/Settings
 * @category Abstract Class
 * @author   WPEverest
 */
class UR_Setting_Separate_shipping extends UR_Field_Settings {


	public function __construct() {
		$this->field_id = 'billing_separate_shipping_advance_setting';
	}
...
return new UR_Setting_Separate_shipping();
