 ...
 *
 * @class    UR_Form_Field_Shipping_First_Name
 * @version  1.0.0
...
/**
 * UR_Form_Field_Shipping_First_Name Class
 */
class UR_Form_Field_Shipping_First_Name extends UR_Form_Field {
	...
	public function __construct() {
		...
		$this->id = 'user_registration_shipping_first_name';
		...
		$this->field_defaults           = array(
			...
			'default_field_name' => 'shipping_first_name',
		);
	...
	public function settings_override( $file_path_override ) {
		$file_path_override['file_path'] = URWC_ABSPATH . 'includes' . UR_DS . 'form' . UR_DS . 'settings' . UR_DS . 'class-ur-setting-shipping-first-name.php';
...
return UR_Form_Field_Shipping_First_Name::get_instance();
