 ...
 *
 * @class    UR_Form_Field_Billing_Address_1
 * @version  1.0.0
...
/**
 * UR_Form_Field_Billing_Address_1 Class
 */
class UR_Form_Field_Billing_Address_1 extends UR_Form_Field {
	...
	public function __construct() {
		...
		$this->id = 'user_registration_billing_address_1';
		...
		$this->field_defaults           = array(
			...
			'default_field_name' => 'billing_address_1',
		);
	...
	public function settings_override( $file_path_override ) {
		$file_path_override['file_path'] = URWC_ABSPATH . 'includes' . UR_DS . 'form' . UR_DS . 'settings' . UR_DS . 'class-ur-setting-billing-address-1.php';
...
return UR_Form_Field_Billing_Address_1::get_instance();
