    ...
    function wppb_in_woo_woocheckbox_form_field($element, $value, $details, $single_prefix){
        ...
        if( !empty( $details['options'] ) ){
            ...
            foreach( $details['options'] as $option ){
                ...
                if ( ($count % 2 ) != 0 ) $element .= '<div class="cozmoslabs-checkbox-list">';

                $element .= '<label class="cozmoslabs-chckbox-container"><input type="checkbox" name="'. $single_prefix . esc_attr( Wordpress_Creation_Kit_PB::wck_generate_slug( $details['title'], $details ) );
