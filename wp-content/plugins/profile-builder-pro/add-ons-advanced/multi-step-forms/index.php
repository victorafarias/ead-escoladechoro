...
function wppb_in_msf_add_meta_boxes() {
    add_meta_box( 'wppb-msf-side', __( 'Multi-Step Forms', 'profile-builder' ), 'wppb_in_msf_meta_boxes_content', array( 'wppb-epf-cpt', 'wppb-rf-cpt', 'profile-builder_page_manage-fields' ), 'normal', 'low' );
}
add_action( 'add_meta_boxes', 'wppb_in_msf_add_meta_boxes', 11 );
add_action( 'wck_add_meta_boxes', 'wppb_in_msf_add_meta_boxes', 11 );
...
function wppb_in_msf_meta_boxes_content( $post ) {
    ...
    if( $screen->id == 'profile-builder_page_manage-fields' ) {
            ...
            <div class="cozmoslabs-columns-container">
                <div class="cozmoslabs-column">
                    ...
                    <div class="cozmoslabs-form-field-wrapper cozmoslabs-toggle-switch">
                        <label class="cozmoslabs-form-field-label" for="pb-default-register"><?php esc_html_e( 'PB Default Register Form', 'profile-builder' ); ?></label>

                        <div class="cozmoslabs-toggle-container">
                            <input type="checkbox" id="pb-default-register" name="pb-default-register" value="yes" <?php echo $wppb_msf_options != 'not_found' && $wppb_msf_options['pb-default-register'] == 'yes' ? 'checked' : ''; ?>>
                            <label class="cozmoslabs-toggle-track" for="pb-default-register"></label>
                        </div>
                    </div>
                    ...
                    <div class="cozmoslabs-form-field-wrapper cozmoslabs-toggle-switch">
                        ...
                        <div class="cozmoslabs-toggle-container">
                            <input type="checkbox" id="pb-default-edit-profile" name="pb-default-edit-profile" value="yes" <?php echo $wppb_msf_options != 'not_found' && $wppb_msf_options['pb-default-edit-profile'] == 'yes' ? 'checked' : ''; ?>>
                            <label class="cozmoslabs-toggle-track" for="pb-default-edit-profile"></label>
                        </div>
                    </div>

                    <p class="cozmoslabs-description" style="margin-top: 20px !important;"><?php esc_html_e( 'To enable it on Multiple Registration and Edit-Profile Forms add Break Points in each form page.', 'profile-builder' ); ?></p>
                </div>

                <div class="cozmoslabs-column">
                    <h4 class="cozmoslabs-subsection-title"><?php echo esc_html__( 'Pagination and Tabs', 'profile-builder' ); ?></h4>

                    <div class="cozmoslabs-form-field-wrapper cozmoslabs-toggle-switch">
                        <label class="cozmoslabs-form-field-label" for="msf-pagination"><?php esc_html_e( 'Enable Pagination', 'profile-builder' ); ?></label>

                        <div class="cozmoslabs-toggle-container">
                            <input type="checkbox" id="msf-pagination" name="msf-pagination" value="yes" <?php echo $wppb_msf_options != 'not_found' && isset( $wppb_msf_options['msf-pagination'] ) && $wppb_msf_options['msf-pagination'] == 'yes' ? 'checked' : ''; ?>>
                            <label class="cozmoslabs-toggle-track" for="msf-pagination"></label>
                        </div>
                    </div>

                    <div class="cozmoslabs-form-field-wrapper cozmoslabs-toggle-switch">
                        <label class="cozmoslabs-form-field-label" for="msf-tabs"><?php esc_html_e( 'Enable Tabs', 'profile-builder' ); ?></label>

                        <div class="cozmoslabs-toggle-container">
                            <input type="checkbox" id="msf-tabs" name="msf-tabs" value="yes" <?php echo $wppb_msf_options != 'not_found' && isset( $wppb_msf_options['msf-tabs'] ) && $wppb_msf_options['msf-tabs'] == 'yes' ? 'checked' : ''; ?>>
                            <label class="cozmoslabs-toggle-track" for="msf-tabs"></label>
                        </div>

                        <div class="cozmoslabs-toggle-description">
                            <span class="wppb-msf-edit-tabs-title" style="display: none" ><a id="wppb-msf-edit-tabs-title" href="#"><?php esc_html_e( 'Edit Tabs Title', 'profile-builder' ); ?></a></span>
                        </div>
                    </div>
        ...
        <h4 class="cozmoslabs-subsection-title"><?php echo esc_html__( 'Pagination and Tabs', 'profile-builder' ); ?></h4>
        <p class="cozmoslabs-description"><?php esc_html_e( 'To enable MSF you must add Break Points.', 'profile-builder' ); ?></p>
        ...
        <div class="cozmoslabs-form-field-wrapper cozmoslabs-toggle-switch">
            ...
            <div class="cozmoslabs-toggle-container">
                <input type="checkbox" id="msf-pagination" name="msf-pagination" value="yes" <?php echo $wppb_msf_post_options != 'not_found' && $wppb_msf_post_options['msf-pagination'] == 'yes' ? 'checked' : ''; ?>>
                <label class="cozmoslabs-toggle-track" for="msf-pagination"></label>
            </div>
        </div>
        ...
        <div class="cozmoslabs-form-field-wrapper cozmoslabs-toggle-switch">
            ...
            <div class="cozmoslabs-toggle-container">
                <input type="checkbox" id="msf-tabs" name="msf-tabs" value="yes" <?php echo $wppb_msf_post_options != 'not_found' && $wppb_msf_post_options['msf-tabs'] == 'yes' ? 'checked' : ''; ?>>
                <label class="cozmoslabs-toggle-track" for="msf-tabs"></label>
            </div>
