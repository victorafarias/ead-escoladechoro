...
function wppb_in_bdp_link_to_visibility_documentation( $mustache_var_group, $id, $post_type ){
    if ( $post_type == 'wppb-ul-cpt' ) {
        if ( ( $id == 'wppb-ul-templates' ) || ( $id == 'wppb-single-ul-templates' ) ) {
            echo '<a href="https://www.cozmoslabs.com/docs/profile-builder/add-ons/buddypress/#User_Listing_field_visibility_syntax" target="_blank">' . esc_html__( 'BuddyPress field visibility syntax', 'profile-builder' ) . '</a> <br>';
        }
    }
}
