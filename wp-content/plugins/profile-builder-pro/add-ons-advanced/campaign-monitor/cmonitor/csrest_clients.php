 ...
 *
 */
class WPPB_IN_CS_REST_Clients extends WPPB_IN_CS_REST_Wrapper_Base {
     ...
     *         )
     * @access public
     * @return WPPB_IN_CS_REST_Wrapper_Result A successful response will be the ID of the newly created client
     */
     ...
     *     )
     * @access public
     * @return WPPB_IN_CS_REST_Wrapper_Result A successful response will be an object
     * of the form:
     * {
