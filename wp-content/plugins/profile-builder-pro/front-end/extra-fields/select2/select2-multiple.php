            ...
            $output = '
				<table class="form-table">
					<tr>
						...
						<td>
							<select name="' . esc_attr($field['meta-name']) . '[]" class="custom_field_select2 wppb-select2" id="' . esc_attr(wppb_handle_meta_name($field['meta-name'])) . '" multiple="multiple" ' . $extra_attr . ' data-wppb-select2-arguments=\'' . json_encode($arguments) . '\'>';
