...
<div id="trp-settings-header">
    ...
    <div id="trp-header-items-wrapper">
        <a class="trp-header-link" href="https://translatepress.com/support/?utm_source=tp-settings&utm_medium=client-site&utm_campaign=header-upsell">
            ...
            <span class="trp-header-item-text trp-primary-text"><?php esc_html_e( 'Support','translatepress-multilingual'); /* [utm72] */?></span>
        </a>
        <a class="trp-header-link" href="https://translatepress.com/docs/translatepress/?utm_source=tp-settings&utm_medium=client-site&utm_campaign=header-upsell">
