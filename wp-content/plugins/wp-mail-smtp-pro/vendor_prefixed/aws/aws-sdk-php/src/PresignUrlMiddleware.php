...
use WPMailSMTP\Vendor\Aws\Signature\SignatureV4;
...
class PresignUrlMiddleware
{
    ...
    private function createPresignedUrl(\WPMailSMTP\Vendor\Aws\AwsClientInterface $client, \WPMailSMTP\Vendor\Aws\CommandInterface $cmd)
    {
        ...
        $request = \WPMailSMTP\Vendor\Aws\serialize($newCmd);
        // Create the new endpoint for the target endpoint.
        if ($this->endpointProvider instanceof \WPMailSMTP\Vendor\Aws\EndpointV2\EndpointProviderV2) {
