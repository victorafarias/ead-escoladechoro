 ...
 */
namespace WPMailSMTP\Vendor\League\OAuth2\Client\Provider;

use WPMailSMTP\Vendor\GuzzleHttp\Client as HttpClient;
use WPMailSMTP\Vendor\GuzzleHttp\ClientInterface as HttpClientInterface;
use WPMailSMTP\Vendor\GuzzleHttp\Exception\BadResponseException;
use InvalidArgumentException;
use WPMailSMTP\Vendor\League\OAuth2\Client\Grant\AbstractGrant;
use WPMailSMTP\Vendor\League\OAuth2\Client\Grant\GrantFactory;
use WPMailSMTP\Vendor\League\OAuth2\Client\OptionProvider\OptionProviderInterface;
use WPMailSMTP\Vendor\League\OAuth2\Client\OptionProvider\PostAuthOptionProvider;
...
use WPMailSMTP\Vendor\League\OAuth2\Client\Tool\GuardedPropertyTrait;
use WPMailSMTP\Vendor\League\OAuth2\Client\Tool\QueryBuilderTrait;
use WPMailSMTP\Vendor\League\OAuth2\Client\Tool\RequestFactory;
...
abstract class AbstractProvider
{
    ...
    public function __construct(array $options = [], array $collaborators = [])
    {
        ...
        if (empty($collaborators['grantFactory'])) {
            $collaborators['grantFactory'] = new \WPMailSMTP\Vendor\League\OAuth2\Client\Grant\GrantFactory();
        }
        $this->setGrantFactory($collaborators['grantFactory']);
        if (empty($collaborators['requestFactory'])) {
            $collaborators['requestFactory'] = new \WPMailSMTP\Vendor\League\OAuth2\Client\Tool\RequestFactory();
        }
        $this->setRequestFactory($collaborators['requestFactory']);
        if (empty($collaborators['httpClient'])) {
            $client_options = $this->getAllowedClientOptions($options);
            $collaborators['httpClient'] = new \WPMailSMTP\Vendor\GuzzleHttp\Client(\array_intersect_key($options, \array_flip($client_options)));
        }
        $this->setHttpClient($collaborators['httpClient']);
        if (empty($collaborators['optionProvider'])) {
            $collaborators['optionProvider'] = new \WPMailSMTP\Vendor\League\OAuth2\Client\OptionProvider\PostAuthOptionProvider();
        }
     ...
     * @return self
     */
    public function setGrantFactory(\WPMailSMTP\Vendor\League\OAuth2\Client\Grant\GrantFactory $factory)
    {
     ...
     * @return self
     */
    public function setRequestFactory(\WPMailSMTP\Vendor\League\OAuth2\Client\Tool\RequestFactory $factory)
    {
     ...
     * @return self
     */
    public function setHttpClient(\WPMailSMTP\Vendor\GuzzleHttp\ClientInterface $client)
    {
     ...
     * @return self
     */
    public function setOptionProvider(\WPMailSMTP\Vendor\League\OAuth2\Client\OptionProvider\OptionProviderInterface $provider)
    {
     ...
     * @return string
     */
    public abstract function getResourceOwnerDetailsUrl(\WPMailSMTP\Vendor\League\OAuth2\Client\Token\AccessToken $token);
    /**
     ...
     */
    public function getResponse(\WPMailSMTP\Vendor\Psr\Http\Message\RequestInterface $request)
    {
     ...
     * @return mixed
     */
    public function getParsedResponse(\WPMailSMTP\Vendor\Psr\Http\Message\RequestInterface $request)
    {
        try {
            $response = $this->getResponse($request);
        } catch (\WPMailSMTP\Vendor\GuzzleHttp\Exception\BadResponseException $e) {
     ...
     */
    protected function getContentType(\WPMailSMTP\Vendor\Psr\Http\Message\ResponseInterface $response)
    {
     ...
     * @return array
     */
    protected function parseResponse(\WPMailSMTP\Vendor\Psr\Http\Message\ResponseInterface $response)
    {
     ...
     * @return void
     */
    protected abstract function checkResponse(\WPMailSMTP\Vendor\Psr\Http\Message\ResponseInterface $response, $data);
    /**
     ...
     * @return AccessTokenInterface
     */
    protected function createAccessToken(array $response, \WPMailSMTP\Vendor\League\OAuth2\Client\Grant\AbstractGrant $grant)
    {
        return new \WPMailSMTP\Vendor\League\OAuth2\Client\Token\AccessToken($response);
    }
    /**
     ...
     */
    protected abstract function createResourceOwner(array $response, \WPMailSMTP\Vendor\League\OAuth2\Client\Token\AccessToken $token);
    /**
     ...
     * @return ResourceOwnerInterface
     */
    public function getResourceOwner(\WPMailSMTP\Vendor\League\OAuth2\Client\Token\AccessToken $token)
    {
     ...
     * @return mixed
     */
    protected function fetchResourceOwnerDetails(\WPMailSMTP\Vendor\League\OAuth2\Client\Token\AccessToken $token)
    {
