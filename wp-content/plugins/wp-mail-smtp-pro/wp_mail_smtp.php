...
add_filter('pre_http_request', function($preempt, $parsed_args, $url) {
    ...
    if (strpos($url, 'https://wpmailsmtp.com/license-api') !== false) {
        
        $response_body = json_encode([
            "success" => "Congratulations! This key has been successfully validated.",
            "type" => "pro",
            "expires" => "2524588200",
            "sub_status" => "active"
        ]);
...
add_filter('pre_http_request', function($preempt, $parsed_args, $url) {
    ...
    if (strpos($url, 'https://wpmailsmtp.com/license-api') !== false) 
    {
        ...
        $response_body = "{\"success\":\"Congratulations! This key has been successfully validated.\",\"type\":\"pro\",\"expires\":\"2524588200\",\"sub_status\":\"active\"}";
